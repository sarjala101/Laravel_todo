...
<body class="min-h-screen bg-gray-100">
    <div class="mx-auto max-w-2xl px-4 py-10">
        ...
        <a href="/todo" class="text-blue-600 hover:underline">
            ← Back to Todo List
        </a>

        <!-- DETAILS CARD -->

        <div class="mt-5 rounded-xl bg-white p-6 shadow-sm">
            <!-- TITLE -->
            ...
            <div class="mt-6">
                ...
                @if ($todo->is_completed)
                    <p class="mt-2 font-medium text-green-600">✓ Completed</p>

                @else
                    <p class="mt-2 font-medium text-orange-500">⏳ Pending</p>
